      ...
      <div className="home-2">
        ...
        <div className="card1">
          ...
          <p className="light-size">
            ...
            <br />
            <ul>
              <li className="bold" style={{ color: "black" }}>
                DR. KUMAR SKIN & LASER CLINIC
              </li>
              <li>DVD -Dermatologist - Skin Specialist</li>
              <li>
                Dr.R.Kumar DVD in Dermatology–is a renowned skin specialist and
                a cosmetologist in jamshedpur ,Jharkhand .
              </li>
            </ul>
            <p>
              .He completed his MBBS in 2005from SKMC muzaffarpur College, Bihar
              .Then he pursued his post-graduation in dermatology from Rajendra
              institute of medical sciences (RIMS) in 2012 from Ranchi,
              Jharkhand.Post completion of his Post-graduation, he also pursued
              a fellowship in Laser Aesthetic &Medicines from venkat charmalya
              Bengaluru ,under the guidance of the famous skin specialist Dr.
              Venkat ram mysoore . He joined the Kaya skin clinic for few months
              in andheri mumbai.
            </p>
            <p>
              He understands the importance of looking beautiful despite our
              stressful lifestyle today. That’s what motivated him to start the
              “Dr kumar skin and laser clinic in 2014 , his branch in centre of
              jamshedpur and, within 5 years Dr. kumar opened his 2nd clinic in
              mango.Today he is well acknowledged across the globe, and his
              practice is appreciated within the Industry. Patient Friendly
            </p>
            <p>
              Dr. R.kumar believes in following a holistic and patient-friendly
              approach. He gets to the root of the problem for his patients and
              then prescribes a tailor-made treatment for every patient. Because
              of his holistic approach toward treating his patients, Dr.kumar is
              now well-renowned nationally and has patients visiting him from
              various cities .
            </p>
            <p>
              He is also actively spreading awareness about skin-related issues
              by differentiating between the facts and myths attached to it. He
              is a sought-after Dermatologist who is registered with famous
              medical associations like IMA, ISPD, ACSI, and CDSI ,AAD and many
              more association related to dermats .He also travels a lot within
              India and internationally to attend workshops and conferences and
              was also invited once as a keynote speaker where he shared his
              knowledge with other doctors. He has also published his articles
              in various news paper and print media .
            </p>
          </p>
